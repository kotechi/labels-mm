        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-gray-50 p-6 rounded-lg border-purple shadow-lg">
                ...
                <div class="py-4">
                    ...
                    <form id="paymentForm" action="{{ route('karyawan.pesanans.paymentProses', $pesanan->id_pesanan) }}" method="POST">
                        @csrf
                        <div class="mt-6">
...
setInterval(function() {
    fetch("{{ route('karyawan.pesanans.detail', $pesanan->id_pesanan) }}")
        .then(res => res.text())
        .then(html => {
