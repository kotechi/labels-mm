    ...
    <div class="p-6 mt-2">
        <form action="{{ route('pesanans.update', $pesanan->id_pesanan) }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="payment_method" id="payment_method" 
                        ...
                        <option value="midtrans" disabled {{ $pesanan->payment_method == 'midtrans' ? 'selected' : '' }}>Midtrans</option>
            ...
            <div class="mt-6 flex justify-end space-x-2">
                <a href="{{ route('pesanans.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-700">Kembali</a>
