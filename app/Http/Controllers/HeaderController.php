...
class HeaderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            if ($request->hasFile('image') && $request->file('image')->isValid()) {
                ...
                return redirect()->route('admin.company.index')->with('success', 'Header created successfully');
            }
    ...
    public function update(Request $request, Header $header)
    {
        ...
        try {
            ...
            return redirect()->route('admin.company.index')->with('success', 'Header updated successfully');
    ...
    public function destroy(Header $header)
    {
        try {
            ...
            $header->delete();
            return redirect()->route('admin.company.index')->with('success', 'Header deleted successfully');
        } catch (\Exception $e) {
